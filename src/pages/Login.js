...
export const Login = () => {
  ...
  async function handleLogin (event){
    ...
    async function handleLoginGuest(){
      email.current.value = "ironman@example.com";
      password.current.value = "ironman";
      try{
        const authDetail = {
          email: email.current.value,
          password: password.current.value
